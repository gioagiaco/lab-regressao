...
#Bernoulli em regressão de sim ou não

#Logistica coloca qualquer valor entre 0 e 1
...
lat_bar23 <- haven::read_dta("Latinobarometro_2023_Esp_Stata_v1_0.dta") %>%
...
### Grafico 
#curve plota o grafico da função
#xlime = c(-5,5) define limites 
...
#na regressão logistica a interpretação do coeficiente é mais dificil, pq não é linear

#Probit
#igual a Logistica mas mais concentrado os valores

#Multiplos Preditores
